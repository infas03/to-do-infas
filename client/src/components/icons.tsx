...
export const EditIcon: React.FC<IconSvgProps> = (props) => {
  return (
    ...
    >
      <path
        d="M15.728 3.728a2.5 2.5 0 0 1 3.536 0l1.06 1.06a2.5 2.5 0 0 1 0 3.536l-9.193 9.193a2.5 2.5 0 0 1-1.768.732H6a1 1 0 0 1-1-1v-2.828a2.5 2.5 0 0 1 .732-1.768l9.193-9.193Z"
        fill="currentColor"
      />
      <path
        d="M4 20h16"
...
export const DeleteIcon: React.FC<IconSvgProps> = (props) => {
  return (
    ...
    >
      <path
        d="M21 5.98c-3.33-.33-6.68-.5-10.02-.5-1.98 0-3.96.1-5.94.3L3 5.98m5.5-1.01.22-1.31C8.88 2.71 9 2 10.69 2h2.62c1.69 0 1.82.75 1.97 1.67l.22 1.3m3.35 4.17-.65 10.07C18.09 19.99 18 22 15.21 22H8.79C6 22 5.91 20 5.8 18.21L5.15 8.14m5.18 7.36h3.33m-8.33-4h10"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="2"
...
export const NotepadIcon: React.FC<IconSvgProps> = (props) => {
  return (
    <svg
      aria-hidden="true"
      fill="none"
